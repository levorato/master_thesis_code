...
SignedGraphPtr SimpleTextGraphFileReader::readGraphFromString(const std::string &graphContents) {
	...
	BOOST_LOG_TRIVIAL(info) << "Successfully created signed graph with " << n << " vertices." << std::endl;
