/*
 * CUDANeighborhoodSearch.h
 *
 *  Created on: May 25, 2014
 *      Author: mlevorato
 */

#ifndef CUDANEIGHBORHOODSEARCH_H_
#define CUDANEIGHBORHOODSEARCH_H_

#include <graph/include/NeighborhoodSearch.h>

namespace clusteringgraph {

class CUDANeighborhoodSearch: public clusteringgraph::NeighborhoodSearch {
public:
	CUDANeighborhoodSearch();
	virtual ~CUDANeighborhoodSearch();
...
#endif /* CUDANEIGHBORHOODSEARCH_H_ */
