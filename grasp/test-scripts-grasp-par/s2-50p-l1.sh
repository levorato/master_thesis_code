...
mpiexec -n $NUMERO_DE_PROCESSOS ./graspcc -l 1 --iter=50 --alpha=0.8 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Social Media/slashdot-undirected/part0" --output-folder "./output/sdot-l1-iter50-0.8-$NUMERO_DE_PROCESSOS-1h" --gain-function-type=0 --time-limit=3600
