...
mpdboot -n 1
mpiexec -n 1 ./graspcc -l 2 --iter=400 --alpha=0.4 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Gisele/Random" --output-folder "./output/rnd-l2-i400-0.4-fi3" --gain-function-type=3
mpdallexit
#FIM DO SCRIPT
