...
mpdboot -n 1
mpiexec -n 1 ./graspcc -l 1 --iter=400 --alpha=1.0 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Social Media/slashdot-undirected/part0" --output-folder "./output/s-l1-400-1.0-fi-imb-boem" --gain-function-type=0 --firstImprovementOnOneNeig=false --time-limit=3600
mpdallexit
#FIM DO SCRIPT
