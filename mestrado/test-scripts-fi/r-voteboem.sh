...
mpdboot -n 1
mpiexec -n 1 ./graspcc -l 1 --iter=-1 --alpha=1.0 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Gisele/Random" --output-folder "./output/rnd-voteboem" --gain-function-type=0 --firstImprovementOnOneNeig=false
mpdallexit
#FIM DO SCRIPT
