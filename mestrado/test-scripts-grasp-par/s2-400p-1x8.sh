...
mpiexec -n $NUMERO_DE_PROCESSOS ./graspcc -l 2 --iter=400 --alpha=0.8 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Social Media/slashdot-undirected/part0" --output-folder "./output/sdot-l2-iter400-0.8-$NUMERO_DE_PROCESSOS-1x8-2h" --gain-function-type=0 --time-limit=7200
