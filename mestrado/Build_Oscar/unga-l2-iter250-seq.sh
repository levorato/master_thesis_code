...
mpdboot -n 1
mpiexec -n 1 ./MestradoMario -l 2 --iter=250 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/UNGA/UNGA_Weighted_SignedGraphs" --output-folder "./output/unga-l2-iter250-seq-1" &
mpiexec -n 1 ./MestradoMario -l 2 --iter=250 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/UNGA/UNGA_Weighted_SignedGraphs" --output-folder "./output/unga-l2-iter250-seq-2" &
mpiexec -n 1 ./MestradoMario -l 2 --iter=250 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/UNGA/UNGA_Weighted_SignedGraphs" --output-folder "./output/unga-l2-iter250-seq-3" &
mpiexec -n 1 ./MestradoMario -l 2 --iter=250 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/UNGA/UNGA_Weighted_SignedGraphs" --output-folder "./output/unga-l2-iter250-seq-4" &
mpiexec -n 1 ./MestradoMario -l 2 --iter=250 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/UNGA/UNGA_Weighted_SignedGraphs" --output-folder "./output/unga-l2-iter250-seq-5" &
#tput-folder "./output/random-l2-iter250-seq-2" &
