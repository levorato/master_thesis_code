...
mpiexec -n $NUMERO_DE_PROCESSOS ./MestradoMario -l 2 --iter=50 --alpha=0.6 --input-file-dir "/home_nfs/mlevorato/mestrado/tests/Instances/Gisele/Literatura/Formato PAJEK" --output-folder "./output/lit-l2-iter50-$NUMERO_DE_PROCESSOS"
